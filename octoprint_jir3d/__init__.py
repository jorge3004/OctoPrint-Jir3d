...
class Jir3dPlugin(
    ...
    def get_assets(self):
        ...
        return {
            "js": ["js/jir3d.js"],
            "css": ["css/jir3d.css"],
            "less": ["less/jir3d.less"]
        }

    def get_template_vars(self):
        return dict(
            url=self._settings.get(["url"]),
            nombre=self._settings.get(["nombre"]),
            # nombre=self._settings.get(["apikey"])
        )
    # ~~ Softwareupdate hook
    ...
    def get_update_information(self):
        ...
        return {
            "jir3d": {
                "displayName": "Jir3d Plugin",
                "displayVersion": self._plugin_version,

                # version check: github repository
                "type": "github_release",
                "user": "jorge3004",
                "repo": "OctoPrint-Jir3d",
                "current": self._plugin_version,

                # update method: pip
                "pip": "https://github.com/jorge3004/OctoPrint-Jir3d/archive/{target_version}.zip",
            }
        }
...
def __plugin_load__():
    ...
    __plugin_implementation__ = Jir3dPlugin()
